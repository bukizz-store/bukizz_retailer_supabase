...
export default function ReturnsPage() {
    ...
    const totalRefundAmount = summaryData?.refundedAmount ?? orders.reduce((sum, o) => sum + Number(o.totalAmount || 0), 0);
    const totalItemsReturned = summaryData?.refundedItems ?? orders.reduce((sum, o) => sum + (o.items?.length || 0), 0);
