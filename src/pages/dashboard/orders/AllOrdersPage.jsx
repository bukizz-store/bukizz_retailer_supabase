...
export default function AllOrdersPage() {
    ...
    // ── For All Orders page: 'all' tab sends no status (API returns everything except initialized) ──
    ...
    // ── Status counts from API (reflects full warehouse) ──
    const counts = {
    ...
    // ── Server already filtered by selected status tab ──
