...
import { Clock, ShieldAlert, LogOut, BookOpen, Phone, Mail } from 'lucide-react';
...
export default function PendingApprovalPage() {
    ...
    const message = verificationStatus?.message || 'Your account is pending admin approval.';
            ...
            <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white dark:bg-slate-950">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className={`w-20 h-20 rounded-full flex items-center justify-center ${isDeactivated
