...
const navItems = [
    ...
    },
    {
        ...
        subItems: [
            { label: 'General Store', href: '/dashboard/inventory/general', icon: <Store className="h-4 w-4" /> },
            { label: 'Inventory Health', href: '/dashboard/inventory/health', icon: <TrendingUp className="h-4 w-4" /> },
            { label: 'My Schools', href: '/dashboard/inventory/schools', icon: <GraduationCap className="h-4 w-4" /> },
        ],
    },
    {
        label: 'Orders',
