        ...
        <div className="h-full bg-white border-r border-gray-200 p-6 flex flex-col">
            ...
            <div className="mb-6">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-lg font-bold text-[#212121]">Bukizz</span>
                </div>
            </div>
            ...
            <div className="bg-[#FFF8E1] rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-[#212121]">Your onboarding</span>
                    <span className="text-xs text-[#878787]">completion status</span>
                </div>
                <div className="flex items-center gap-3">
                    <div className="relative w-14 h-14">
                        <svg className="w-full h-full -rotate-90">
                            <circle cx="28" cy="28" r="24" stroke="#E0E0E0" strokeWidth="4" fill="none" />
                            <circle
                                cx="28" cy="28" r="24"
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-sm font-bold text-[#FF9F00]">{completionPercentage}%</span>
                        </div>
                    </div>
                        ...
                        <div key={step.id} className="mb-4">
                            <div className="flex items-start gap-3">
                                <div className={cn(
                                    ...
                                    isCompleted || isPast ? "bg-[#26A541] text-white" :
                                        isCurrent ? "bg-[#2874F0] text-white ring-2 ring-[#2874F0]/20" :
                                ...
                                <div className="flex-1">
                                    <p className={cn(
                                        "text-sm font-medium",
                                        isCurrent ? "text-[#212121]" :
                                            isCompleted || isPast ? "text-[#26A541]" :
                                                "text-[#878787]"
                                    )}>
                                        {step.title}
                                    </p>
                                    ...
                                    {step.substeps.map((substep, subIndex) => (
                                        <div key={subIndex} className="flex items-center gap-2">
                                            <div className={cn(
                                                ...
                                                (isCompleted || isPast) ? "bg-[#26A541]" :
                                                    (isCurrent && subIndex === 0) ? "bg-[#2874F0]" :
                                                        "bg-transparent border border-gray-300"
                                            )}>
                                                {(isCompleted || isPast || (isCurrent && subIndex === 0)) && (
                                            ...
                                            <span className={cn(
                                                "text-xs",
                                                (isCompleted || isPast) ? "text-[#26A541]" :
                                                    (isCurrent && subIndex === 0) ? "text-[#2874F0]" :
                                                        "text-[#ABABAB]"
                                            )}>
                                                {substep}
                                            </span>
