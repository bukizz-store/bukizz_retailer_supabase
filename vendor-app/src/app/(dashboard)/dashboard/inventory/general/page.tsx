...
import { GeneralProductCategory } from '@/types';
import {
    Plus,
    Search,
    Filter,
...
const categories: { id: GeneralProductCategory | 'all'; label: string; icon: string }[] = [
...
export default function GeneralStorePage() {
    const [selectedCategory, setSelectedCategory] = useState<GeneralProductCategory | 'all'>('all');
