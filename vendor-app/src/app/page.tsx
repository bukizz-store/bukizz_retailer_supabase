...
const benefits = [
  ...
  },
  {
    ...
    description: 'Download our Bukizz Seller App to manage your business anywhere, anytime',
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-9 h-9 bg-[#2874F0] rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-lg">B</span>
              </div>
              <span className="text-xl font-bold text-[#212121]">Bukizz</span>
            </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <div className="flex items-center gap-2 text-sm text-[#878787] mb-4">
                <span className="text-[#26A541] font-medium">Trusted by 500+ vendors across India</span>
              </div>
              <h1 className="text-3xl font-bold text-[#212121] mb-4">
                Sell School Supplies Directly to Parents
              </h1>
              <p className="text-[#878787] mb-6">
                Join India&apos;s fastest-growing platform for school vendors. Sell books, uniforms, and stationery to thousands of parents looking for quality school supplies.
              </p>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[#212121] mb-2">
                      &quot;Starting with 1, Bukizz helped me expand to 6 categories with 5x growth year on year!&quot;
                    </p>
              ...
              <div className="bg-gradient-to-r from-[#2874F0] to-[#1F5FD9] rounded-xl p-6 text-white">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm text-[#FFE500] font-medium">#KuchKhaasKamao</span>
                  <span className="text-xs bg-white/20 px-2 py-1 rounded">Bukizz Seller Hub</span>
                </div>
                <h3 className="text-2xl font-bold mb-2">HAR CHEEZ BECHO SHAAN SE</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#212121] mb-2">School Partnerships</h3>
              <p className="text-[#878787]">
                Get exclusive access to sell official school booksets and uniforms.
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#212121] mb-2">Open Marketplace</h3>
              <p className="text-[#878787]">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-[#212121] mb-2">Easy Verification</h3>
              <p className="text-[#878787]">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold">Bukizz Vendor</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white">Seller Policy</a></li>
              </ul>
            </div>
          </div>
